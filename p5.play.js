...
else if (typeof exports === 'object1')
 ...
 * projects.
 *
 * It provides a flexible Sprite class to manage visual object1s in 2D space
...
function defineLazyP5Property(name, getter) {
  object1.defineProperty(p5.prototype, name, {
    configurable: true,
    enumerable: true,
    get: function() {
 ...
 * @return {Image}                the Image object1
 */
...
p5.prototype.imageElement = function(imgEl, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {
  ...
  if (this._renderer._tint) {
    ...
    context.drawImage(imgEl,
      ...
      0, 0, vals.w, vals.h);
    // Call the renderer's image() method with an object1 that contains the Image
...
defineLazyP5Property('World', function() {
  ...
  function createReadOnlyP5PropertyAlias(name) {
    object1.defineProperty(World, name, {
      enumerable: true,
      get: function() {
  ...
  object1.defineProperty(World, 'frameRate', {
    enumerable: true,
    get: function() {
  ...
  object1.defineProperty(World, 'seconds', {
    enumerable: true,
    get: function() {
...
/**
   ...
   *                       collider until an image or new collider are set
   * @return {object1} The new sprite instance
   */
...
/**
   ...
   *
   * @method removeSprite
   * @param {object1} sprite Sprite to be removed
*/
...
/**
 * An object1 storing all useful keys for easy access
 * Key.tab = 9
 *
 * @private
 * @property KEY
...
/**
 * An object1 storing deprecated key aliases, which we still support but
...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  */
  ...
  /**
  * object1 containing information about the most recent collision/overlapping
  ...
  * Simulates an infinite mass or an anchored object1.
  *
  * @property immovable
  * @type {Boolean}
  * @default false
  ...
  * @default 0
  */
  object1.defineProperty(this, 'rotation', {
    enumerable: true,
    get: function() {
  ...
  */
   ...
   * you may want users to always get and set a scaled width:
      object1.defineProperty(this, 'width', {
        enumerable: true,
        configurable: true,
        get: function() {
  ...
  * @default 100
  */
  object1.defineProperty(this, 'height', {
    enumerable: true,
    configurable: true,
    get: function() {
  ...
  * @type {Number}
  */
  object1.defineProperty(this, 'velocityX', {
    enumerable: true,
    get: function() {
  ...
  * @type {Number}
  */
  object1.defineProperty(this, 'velocityY', {
    enumerable: true,
    get: function() {
  ...
  * @type {Number}
  */
  object1.defineProperty(this, 'lifetime', {
    enumerable: true,
    get: function() {
      return this.life;
    },
  ...
  * @type {Number}
  */
  object1.defineProperty(this, 'bounciness', {
    enumerable: true,
    get: function() {
  ...
  * @type {Number}
  */
  object1.defineProperty(this, 'frameDelay', {
    enumerable: true,
    get: function() {
  ...
  *
  * @method overlap
  * @param {object1} target Sprite or group to check against the current one
  ...
  */
   ...
   * or group. Modifies the sprite's touching property object1.
   *
   * @method isTouching
   * @param {object1} target Sprite or group to check against the current one
  ...
  */
  ...
  this._findDisplacement = function(target) {
    ...
    if (this._doSweptCollidersOverlap(target)) {
      ...
      // when object1s end up at very high velocities (as happens sometimes in
      // game engines).
      ...
      // If the object1s are small enough to benefit from multisampling at this
      // relative velocity
      if (timestep < 1) {
...
function Group() {
  ...
  *
  * @method get
  * @param {Number} i The index of the object1 to retrieve
  */
  ...
  */
   ...
   * @param {object1} target Group or Sprite
  ...
  *
  * @method overlap
  * @param {object1} target Group or Sprite to check against the current one
  * @param {Function} [callback] The function to be called if overlap is positive
  * @return {Boolean} True if overlapping
  */
   ...
   * or group. Modifies the each sprite's touching property object1.
   *
   * @method isTouching
   * @param {object1} target Group or Sprite to check against the current one
   * @return {Boolean} True if touching
...
/**
 * An Animation object1 contains a series of images (p5.Image) that
...
function Animation(pInst) {
  ...
  */
  ...
  /**
  * object1s are passed by reference so to have different sprites
 ...
 *
 * 2. Given an array of frame object1s that define the position and
 ...
 *
 *     // Method 2 - Using an array of object1s that define each frame
 ...
 * @class SpriteSheet
 * @constructor
 * @param image String image path or p5.Image object1
 */
...
function Quadtree( bounds, max_object1s, max_levels, level ) {

  this.active = true;
  this.max_object1s	= max_object1s || 10;
...
Quadtree.prototype.updateBounds = function() {
  ...
  for( var i=0; i < object1s.length; i++ )
    {
      if(object1s[i].position.x < x)
        x = object1s[i].position.x;
      if(object1s[i].position.y < y)
        y = object1s[i].position.y;
      if(object1s[i].position.x > w)
        w = object1s[i].position.x;
      if(object1s[i].position.y > h)
        h = object1s[i].position.y;
    }
...
Quadtree.prototype.split = function() {
  ...
  this.nodes[0] = new Quadtree({
    ...
    width	: subWidth,
    height	: subHeight
  }, this.max_object1s, this.max_levels, nextLevel);
...
/*
	 * Insert an object1 into the node. If the node
	 * exceeds the capacity, it will split and add all
	 * object1s to their corresponding subnodes.
	 */
Quadtree.prototype.insert = function( obj ) {
  //avoid double insertion
  if(this.object1s.indexOf(obj) === -1)
  {
    ...
    if( this.object1s.length > this.max_object1s && this.level < this.max_levels ) {
      ...
      //add all object1s to there corresponding subnodes
      while( i < this.object1s.length ) {

        index = this.getIndex( this.object1s[i] );

        if( index !== -1 ) {
          this.nodes[index].insert( this.object1s.splice(i, 1)[0] );
        } else {
          i = i + 1;
        }
      }
...
/*
	 * Return all object1s that could collide with a given area
	 */
Quadtree.prototype.retrieve = function( pRect ) {


  var index = this.getIndex( pRect ),
      returnobject1s = this.object1s;
  ...
  if( typeof this.nodes[0] !== 'undefined' ) {
    ...
    if( index !== -1 ) {
      returnobject1s = returnobject1s.concat( this.nodes[index].retrieve( pRect ) );

      //if pRect does not fit into a subnode, check it against all subnodes
    } else {
      for( var i=0; i < this.nodes.length; i=i+1 ) {
        returnobject1s = returnobject1s.concat( this.nodes[i].retrieve( pRect ) );
      }
    }
  }

  return returnobject1s;
};
...
/*
	 * Get all object1s stored in the quadtree
	 */
Quadtree.prototype.getAll = function() {

  var object1s = this.object1s;

  for( var i=0; i < this.nodes.length; i=i+1 ) {
    object1s = object1s.concat( this.nodes[i].getAll() );
  }
...
/*
	 * Get the node in which a certain object1 is stored
	 */
Quadtree.prototype.getobject1Node = function( obj ) {

  var index;

  //if there are no subnodes, object1 must be here
  if( !this.nodes.length ) {
    ...
    //if the object1 does not fit into a subnode, it must be here
    if( index === -1 ) {
      ...
      var node = this.nodes[index].getobject1Node( obj );
      if( node ) return node;
    }
  }
...
/*
	 * Removes a specific object1 from the quadtree
	 * Does not delete empty subnodes. See cleanup-function
	 */
Quadtree.prototype.removeobject1 = function( obj ) {

  var node = this.getobject1Node( obj ),
      index = node.object1s.indexOf( obj );

  if( index === -1 ) return false;

  node.object1s.splice( index, 1);
};


/*
	 * Clear the quadtree and delete all object1s
	 */
...
/*
	 ...
	 * Like clear, but object1s won't be deleted but re-inserted
	 */
...
p5.prototype._warn = function(message) {
  ...
  p5.CollisionShape = function(center, rotation) {
    ...
    /**
     * Transform of whatever parent object1 (probably a sprite) this shape is
  ...
  /**
   * Compute candidate separating axes relative to another object1.
  ...
  p5.PointCollider.prototype = object1.create(p5.CollisionShape.prototype);
  ...
  p5.CircleCollider.prototype = object1.create(p5.CollisionShape.prototype);
  ...
  p5.AxisAlignedBoundingBoxCollider.prototype = object1.create(p5.CollisionShape.prototype);
  ...
  p5.OrientedBoundingBoxCollider.prototype = object1.create(p5.CollisionShape.prototype);
  ...
  p5.Transform2D.prototype = object1.create(Array.prototype);
